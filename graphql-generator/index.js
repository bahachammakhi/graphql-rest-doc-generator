...
module.exports = function (options) {
  ...
  function loadData() {
    ...
    var specData = require(path.resolve(opts.appDir + "/dociql/index"))(
      specPath,
      opts.header
    );
  ...
  if (!exists) process.chdir(__dirname);
  ...
  grunt.registerTask("foundation", [
    "sass:foundation_scss",
    "concat:foundation_css",
  ]); // 'concat:foundation_js'
